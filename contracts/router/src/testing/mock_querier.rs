...
use ura::contracts::pair::SimulationResponse;
...
/// This uses the Ura CustomQuerier.
...
pub struct WasmMockQuerier {
    ...
    ura_factory_querier: UraFactoryQuerier,
}
...
#[derive(Clone, Default)]
pub struct UraFactoryQuerier {
    pairs: HashMap<String, String>,
}

impl UraFactoryQuerier {
    ...
    fn handle_default(&self, msg: &Binary) -> QuerierResult {
        match from_json(&msg).unwrap() {
            QueryMsg::Pair { asset_infos } => {
                ...
                match self.ura_factory_querier.pairs.get(&key) {
                    Some(v) => SystemResult::Ok(ContractResult::from(to_json_binary(&PairInfo {
                        ...
                        liquidity_token: AssetInfo::Token {
                            contract_addr: Addr::unchecked("liquidity".to_string()),
                        },
                        asset_infos: vec![
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier<Empty>) -> Self {
        WasmMockQuerier {
            ...
            ura_factory_querier: UraFactoryQuerier::default(),
        }
    }
    ...
    pub fn with_ura_pairs(&mut self, pairs: &[(&String, &String)]) {
        self.ura_factory_querier = UraFactoryQuerier::new(pairs);
    }
}
