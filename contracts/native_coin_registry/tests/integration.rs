...
use ura::contracts::native_coin_registry::{
    CoinResponse, Config, ExecuteMsg, InstantiateMsg, QueryMsg,
};
...
fn store_native_registry_code(app: &mut App) -> u64 {
    let contract = Box::new(ContractWrapper::new_with_empty(
        ura_native_coin_registry::contract::execute,
        ura_native_coin_registry::contract::instantiate,
        ura_native_coin_registry::contract::query,
    ));
